...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-03-2026 a las 05:26:35
...
--
-- Volcado de datos para la tabla `informacion_cliente`
--

INSERT INTO `informacion_cliente` (`id_info`, `id_usuario`, `telefono`, `ciudad`, `direccion`, `foto`, `fecha_actualizacion`) VALUES
(6, 13, '3209029070', 'Tolima', 'Cra2A', 'uploads/perfiles/perfil_13_1770220775.jpg', '2026-02-04 15:59:35'),
(7, 1, '3012331102', 'Ibagué', 'Cra 10A #10-58', 'uploads/perfiles/perfil_1_1770073151.jpg', '2026-02-02 22:59:11');
...
INSERT INTO `pedidos` (`id`, `id_usuario`, `codigo_pedido`, `total`, `estado`, `fecha`) VALUES
(1, 15, '6234', 370000.00, 0, '2026-02-18 10:34:20'),
(2, 15, '1116', 24000.00, 0, '2026-02-18 11:14:35'),
(3, 15, '9823', 14000.00, 0, '2026-02-18 11:17:19');
...
INSERT INTO `pedido_detalle` (`id`, `id_pedido`, `nombre_producto`, `precio`, `cantidad`) VALUES
(1, 1, 'Pizza Primavera - Mediana', 29000.00, 10),
(2, 1, 'Gaseosa Grande (1.5L)', 8000.00, 10),
(3, 2, 'Olio con Camarones y Champiñones', 24000.00, 1),
(4, 3, 'Hamburguesa Irriverente', 14000.00, 1);
...
--
ALTER TABLE `informacion_cliente`
  ADD CONSTRAINT `fk_usuario_info` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE CASCADE;
COMMIT;
