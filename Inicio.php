...
<body> <!-- Comienza el contenido visible en el navegador -->
  ...
  <section class="orden">
    <div class="orden-texto">
      <h1><u>COMIENZA TU ORDEN</u></h1>
      <div class="botones">
        <a href="Domicilio.php" class="btn-domicilio">DOMICILIO</a>
        <a href="Tienda.php" class="btn-tienda">RECOGER EN TIENDA</a>
      </div>
    </div>
    ...
    <div class="carousel-section">
      <div class="swiper-container">
        <div class="swiper-wrapper">
          <div class="swiper-slide"><img src="Imagenes/Pizza 1.jpg" alt="Pizza 1"></div>
          <div class="swiper-slide"><img src="Imagenes/Pizza 2.jpg" alt="Pizza 2"></div>
          <div class="swiper-slide"><img src="Imagenes/pizza 3.jpg" alt="Pizza 3"></div>
          <div class="swiper-slide"><img src="Imagenes/pizza 4.jpg" alt="Pizza 4"></div>
          <div class="swiper-slide"><img src="Imagenes/pizza 5.jpg" alt="Pizza 5"></div>
          <div class="swiper-slide"><img src="Imagenes/pizza 6.jpg" alt="Pizza 6"></div>
        </div>
      </div>
    </div>
  </section>
