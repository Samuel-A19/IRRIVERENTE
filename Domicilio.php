      ...
      <div class="pedido-formulario">
        ...
        <form id="form-pedido-domicilio">
          ...
          <div class="campo">
            ...
            <input type="tel" id="telefono" name="telefono" placeholder="Tu número de teléfono" maxlength="10"
          ...
          <div class="campo">
            ...
            <input type="text" id="direccion" name="direccion" placeholder="Escribe tu dirección completa" required>
            <div class="error-msg" id="err-direccion"></div>
          </div>

          <div class="campo">
            <label for="referencias">Referencias de ubicación</label>
            <input type="text" id="referencias" name="referencias" placeholder="Opcional, indica puntos cercanos">
