  ...
  <body>
    <div class="contenedor-tienda">
      <div class="pedido-formulario">
        <h2>¡Ordena y recoge en tienda!</h2>
        <p class="sub-texto">Haz tu pedido desde la web y recoge en la comodidad de nuestra tienda.</p>
        <form id="form-pedido-tienda" novalidate>
          <div class="campo">
            <label for="nombre">Nombre completo</label>
            <input type="text" id="nombre" name="nombre" placeholder="Escribe tu nombre completo" required>
            <div class="error-msg" id="err-nombre">Por favor ingresa tu nombre completo.</div>
          </div>
          ...
          <div class="campo">
            ...
            <input type="tel" id="telefono" name="telefono" placeholder="Tu número de teléfono" required
              pattern="^\d{7,15}$">
            <div class="error-msg" id="err-telefono">Por favor ingresa un número válido (7-15 dígitos).
            </div>
          </div>

          <button type="submit" id="btnContinuar" class="btn-confirmar">CONTINUAR</button>
        </form>
      </div>
    </div>
  </body>
